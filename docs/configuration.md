...
|----------|---------|-------------|
| `PROJECT_NAME` | `agent-chat-app` | Display name for the project |
...
| `POSTGRES_DB` | `agent_chat_app` | Database name |
...
| `LOGFIRE_SERVICE_NAME` | `agent_chat_app` | Service name in Logfire dashboard |
...
| `S3_BUCKET` | `agent_chat_app` | Bucket name |
